...
def test_geotiff_extract_bbox():
    result = geoextent.from_file("tests/testdata/tif/wf_100m_klas.tif", bbox=True)
...
def test_geotiff_extract_time():
    result = geoextent.from_file("tests/testdata/tif/wf_100m_klas.tif", tbox=True)
...
def test_ungeoreferenced_raster_skipped_by_default():
    ...
    try:
        ...
        result = geoextent.from_file(tmp_path, bbox=True)
...
def test_ungeoreferenced_raster_with_assume_wgs84():
    ...
    try:
        ...
        result2 = geoextent.from_file(tmp_path, bbox=True, assume_wgs84=True)
