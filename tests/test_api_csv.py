...
def test_csv_extract_tbox():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL.csv", bbox=False, tbox=True
    )
...
def test_csv_extract_bbox_and_tbox():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "tbox" in result
    assert "crs" in result
...
def test_csv_extract_bbox_and_tbox_comma_delimiter():
    result = geoextent.fromFile(
        "tests/testdata/csv/csv_comma_delimiter.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "tbox" in result
    assert "crs" in result
...
def test_csv_extract_bbox_and_tbox_with_time():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_Time.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "tbox" in result
    assert "crs" in result
...
def test_csv_extract_bbox_and_tbox_with_timestamp():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_TimeStamp.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "tbox" in result
    assert "crs" in result
...
def test_csv_extract_bbox_and_tbox_with_datetime():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_Datetime.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_lat_long():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_LATITUDE.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_lat_long_2():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_LAT.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_time_date():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_TIME_DATE.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_cols_diff_order():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_case1.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_cols_diff_order_caps():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_case2.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_cols_diff_order_and_alt_names1():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_case3.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_cols_diff_order_and_alt_names2():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_case4.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_bbox_and_tbox_with_cols_diff_order_and_alt_names3():
    result = geoextent.fromFile(
        "tests/testdata/csv/cities_NL_case5.csv", bbox=True, tbox=True
    )
    assert "bbox" in result
    assert "crs" in result
    assert "tbox" in result
...
def test_csv_extract_tbox_iso8601_time_format():
    result = geoextent.fromFile(
        "tests/testdata/csv/3DCMTcatalog_TakemuraEPS.csv", bbox=False, tbox=True
    )
    assert "bbox" not in result
