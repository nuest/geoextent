...
_PROVIDER_FILES = {
    ...
    "test_api_gfz.py",
    "test_api_pensoft.py",
    "test_api_journals_ojs.py",
    "test_api_journals_janeway.py",
    "test_api_opara.py",
...
_FAST_PATTERNS = {
    ...
    "parse_wkt_point",
    "extract_coordinates",
    "extract_doi_from_jsonld",
    "priority_jsonld_over_geo_position",
    "extract_admin_unit_only_yields_no_bbox",
    "extract_dc_temporal_not_pubdate",
    "iso19139_parser_is_namespace_prefix_agnostic",
    "iso19139_parser_handles_html_escaped_input",
    "mutually_exclusive",
...
_PROVIDER_SAMPLE_TESTS = {
    ...
    "test_ojs_metadata_only_extraction_tib_demo",
    ...
    "test_dataone_metadata_only_extraction",
    ...
    "test_gdide_metadata_only_extraction",
